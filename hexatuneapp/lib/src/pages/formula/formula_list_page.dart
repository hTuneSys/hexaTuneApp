...
class _FormulaListPageState extends State<FormulaListPage> {
  ...
  void _showSortSheet() {
    ...
    final options = <(String, String)>[
      ('', l10n.formulaSortDefault),
      ('name', l10n.formulaSortNameAsc),
      ('-name', l10n.formulaSortNameDesc),
      ('-created_at', l10n.formulaSortNewest),
      ('created_at', l10n.formulaSortOldest),
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.formulaManagement)),
      body: Column(
        children: [
  ...
  Widget _buildBody(AppLocalizations l10n, ThemeData theme) {
    if (_isLoading && _formulas.isEmpty) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(l10n.formulaEmptyTitle, style: theme.textTheme.titleMedium),
            const SizedBox(height: 8),
            Text(
              l10n.formulaEmptyHint,
          ...
          return _FormulaListTile(
            ...
            onEdit: () async {
              final updated = await context.push<bool>(
                RouteNames.formulaEditFor(f.id),
              );
              if (updated == true) {
                _loadLabels();
                _load();
            ...
            onView: () => context.push(RouteNames.formulaViewFor(f.id)),
          );
        },
      ),
    );
