...
class DspAssetService {
  ...
  static final Map<String, String Function(AppLocalizations)> _nameKeyMap = {
    ...
    'ambienceTextureFire': (l) => l.ambienceTextureFire,
    'ambienceTextureGrass': (l) => l.ambienceTextureGrass,
    'ambienceTextureLeaf': (l) => l.ambienceTextureLeaf,
    'ambienceTextureNight': (l) => l.ambienceTextureNight,
    'ambienceTextureSnow': (l) => l.ambienceTextureSnow,
    'ambienceTextureSoftWind': (l) => l.ambienceTextureSoftWind,
    'ambienceTextureStrongWind': (l) => l.ambienceTextureStrongWind,
    'ambienceTextureWaterDrop': (l) => l.ambienceTextureWaterDrop,
    'ambienceTextureWave': (l) => l.ambienceTextureWave,
    'ambienceEventBirdChirping1': (l) => l.ambienceEventBirdChirping1,
    'ambienceEventBirdChirping2': (l) => l.ambienceEventBirdChirping2,
    'ambienceEventBirdWing': (l) => l.ambienceEventBirdWing,
    'ambienceEventBush': (l) => l.ambienceEventBush,
    'ambienceEventCrumble': (l) => l.ambienceEventCrumble,
    'ambienceEventFrog': (l) => l.ambienceEventFrog,
    'ambienceEventInsect': (l) => l.ambienceEventInsect,
    'ambienceEventOwl': (l) => l.ambienceEventOwl,
    'ambienceEventStone': (l) => l.ambienceEventStone,
    'ambienceEventThunder': (l) => l.ambienceEventThunder,
    'ambienceEventTwig': (l) => l.ambienceEventTwig,
    'ambienceEventWaterDrop': (l) => l.ambienceEventWaterDrop,
    'ambienceEventWaterSplash': (l) => l.ambienceEventWaterSplash,
    'ambienceEventWoodCrack': (l) => l.ambienceEventWoodCrack,
    'ambienceEventWoodpecker': (l) => l.ambienceEventWoodpecker,
  };
