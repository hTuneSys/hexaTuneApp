...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateCategoryRequest&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.labels, labels));
}
...
@override
String toString() {
  return 'UpdateCategoryRequest(name: $name, labels: $labels)';
}
...
class _UpdateCategoryRequest implements UpdateCategoryRequest {
  const _UpdateCategoryRequest({this.name, final  List<String>? labels}): _labels = labels;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateCategoryRequest&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._labels, _labels));
}
