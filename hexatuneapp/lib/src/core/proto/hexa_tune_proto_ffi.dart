...
typedef _HtpSysexUnframeNative =
    Int32 Function(
...
typedef _HtpUsbPacketizeNative =
    Int32 Function(
...
typedef _HtpUsbDepacketizeNative =
    Int32 Function(
...
typedef _HtpUsbDepacketizeDart =
    int Function(
...
typedef _HtpEncodeToPacketsNative =
    Int32 Function(
      Pointer<Uint8> namePtr,
      IntPtr nameLen,
      Uint32 id,
...
typedef _HtpEncodeToPacketsDart =
    int Function(
      Pointer<Uint8> namePtr,
      int nameLen,
      int id,
...
class AtParseResult {
  ...
  @override
  String toString() =>
      'AtParseResult(name=$name, id=$id, op=$op, params=$params)';
}
...
class HexaTuneProto {
  ...
  void _bindAll() {
    _atEncode = _lib.lookupFunction<_HtpAtEncodeNative, _HtpAtEncodeDart>(
      'htp_at_encode',
    );
    _atParse = _lib.lookupFunction<_HtpAtParseNative, _HtpAtParseDart>(
      'htp_at_parse',
    );
    _sysexFrame = _lib.lookupFunction<_HtpSysexFrameNative, _HtpSysexFrameDart>(
      'htp_sysex_frame',
    );
    _sysexUnframe = _lib
        .lookupFunction<_HtpSysexUnframeNative, _HtpSysexUnframeDart>(
          'htp_sysex_unframe',
        );
    _usbPacketize = _lib
        .lookupFunction<_HtpUsbPacketizeNative, _HtpUsbPacketizeDart>(
          'htp_usb_packetize',
        );
    _usbDepacketize = _lib
        .lookupFunction<_HtpUsbDepacketizeNative, _HtpUsbDepacketizeDart>(
          'htp_usb_depacketize',
        );
    _encodeToPackets = _lib
        .lookupFunction<_HtpEncodeToPacketsNative, _HtpEncodeToPacketsDart>(
