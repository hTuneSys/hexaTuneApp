...
# Contributing to hexaTuneApp

Thank you for your interest in contributing to **hexaTuneApp**!  
...
- [Getting Started](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/GETTING_STARTED.md)
- [Architecture](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/ARCHITECTURE.md)
- [Branch Strategy](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/BRANCH_STRATEGY.md)
- [Project Board](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/PROJECT_BOARD.md)
- [FAQ](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/FAQ.md)
- [README](https://github.com/hTuneSys/hexaTuneApp#readme)
...
Please follow our [Branching Guide](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/BRANCH_STRATEGY.md)
...
All contributions are tracked in the [Project Board](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/PROJECT_BOARD.md):
...
Refer to [Labelling Strategy](https://github.com/hTuneSys/hexaTuneApp/blob/main/docs/LABELLING_STRATEGY.md)
...
- Questions? Use [GitHub Discussions](https://github.com/hTuneSys/hexaTuneApp/discussions)
- For sensitive topics, contact [info@hexatune.com](mailto:info@hexatune.com)
- Please follow our [Code of Conduct](https://github.com/hTuneSys/hexaTuneApp/blob/main/.github/CODE_OF_CONDUCT.md)

We’re excited to build hexaTuneApp with your help 🚀
