...
Frequently Asked Questions (FAQ) about the hexaTuneApp project. If you have a question not listed here, feel free to open a GitHub Discussion or an Issue.
...
Open an issue using the [Bug Report Template](https://github.com/hTuneSys/hexaTuneApp/issues/new?template=bug-report.md) and provide as much detail as possible.

---

## ❓ What should I do if I have a feature idea?

Use the [Feature Request Template](https://github.com/hTuneSys/hexaTuneApp/issues/new?template=feature-request.md) or start a discussion to propose your idea.

---

## ❓ How is this project licensed?

hexaTuneApp is licensed under the MIT License. See the [LICENSE](https://github.com/hTuneSys/hexaTuneApp/blob/main/LICENSE) file for more details.
