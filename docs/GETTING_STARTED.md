...
# 🚀 Getting Started with hexaTuneApp

Welcome to the hexaTuneApp project! This guide will help you set up your development environment, build the project components, and get started with contributing or using hexaTuneApp.
...
3. **Connect your hexaTuneApp device** via USB and put it in BOOTSEL mode (hold BOOTSEL button while plugging in).
...
1. **Open KiCad** and load the project:
   - Navigate to `hardware/hexaTuneApp-v1/`
   - Open `hexaTuneApp-v1.kicad_pro`

2. **View schematics**:
   - Open `hexaTuneApp-v1.kicad_sch`

3. **View PCB layout**:
   - Open `hexaTuneApp-v1.kicad_pcb`
...
You're now ready to explore and build with hexaTuneApp. Happy hacking!
